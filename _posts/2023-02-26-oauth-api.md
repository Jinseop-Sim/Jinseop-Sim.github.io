...
> Please, consider using the org.springframework.web.reactive.client.WebClient which has a more  
> modern API and supports sync, async, and streaming scenarios.  
